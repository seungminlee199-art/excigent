...
(function initHeroSearch() {
  const SEARCH_DATA = [
    ...
    { title:'About Excigent',         cat:'Company',   url:'/about/' },
    { title:'Geographic Reach',       cat:'Company',   url:'/about/#network' },
    { title:'Leadership Team',        cat:'Team',      url:'/team/' },
    { title:'News & Insights',        cat:'News',      url:'/news/' },
    { title:'Contact Us',             cat:'Contact',   url:'/contact/' },
  ];
